...
b = random.sample(range(0, 10000), 10)
...
def hashFunction(shingle, length):
    hashValues = []
    for i in range(10):
        hashValues.append((a[i] * shingle + b[i]) % length)
    return hashValues
...
signatureMatrix = {postId:[42345600 for i in range(10)] for postId in postIds}
